...
**Thoughtful AI** (2024 - Present) — Customer Success Analyst bridging customers and engineering. End-to-end delivery and optimization of AI/RPA automation solutions for US healthcare revenue cycles. Python, RPA, OCR, API integrations, IaaS/PaaS, Jira.

**Dataprise — National Spine and Center** (2023 - 2024) — IT Engineer II. Azure cloud security (Private Link, NSGs, Defender for Cloud), Windows deployment, Active Directory, Microsoft 365, Mimecast, endpoint management.
...
[![Email](https://img.shields.io/badge/Email-D14836?style=flat&logo=gmail&logoColor=white)](mailto:ludwing_pv@hotmail.com)
